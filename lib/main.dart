...
class _MainAppState extends State<MainApp> with SingleTickerProviderStateMixin {
  ...
  Widget game(BuildContext context, isLettresGame) {
            ...
            child: Column(
              ...
              children: [
                Card(
                  ...
                  child: Container(
                    width: width * 0.6,
                    height: height * (isLettresGame ? 0.5 : 0.45),
                    margin: EdgeInsets.symmetric(horizontal: 20),
                    child: Column(
                      children: [
                        SizedBox(height: 10),
                        Text(
                          isLettresGame ? "MOTS TROUVÉS" : "VOUS DEVEZ ATTEINDRE : $cible",
                          style: TextStyle(
                            fontSize: 20,
                            color: Colors.cyan[900],
                            fontWeight: FontWeight.bold,
                        ...
                        Expanded(
                          child: GridView.builder(
                            itemCount: isLettresGame ? motTrouves.length : chiffresTrouves.length,
                            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                              crossAxisCount: 4,
                              childAspectRatio: isLettresGame ? 3 : 2,
                              crossAxisSpacing: 8,
                              mainAxisSpacing: isLettresGame ? 8 : 0,
                            ),
                            itemBuilder: (context, index) {
                              return Card(
                                ...
                                child: Center(
                                  child: Text(
                                    isLettresGame ? motTrouves[index] : chiffresTrouves[index].toString(),
                                    style: TextStyle(
                                      fontSize: 20,
                                      color: Colors.cyan[900],
                                      fontWeight: FontWeight.bold,
                  ...
                  child: Center(
                    child: SingleChildScrollView(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...buildCases(
                            isLettresGame ? boiteLettres.length : boiteChiffres.length,
                            (index) {
                              setState(() {
                                if (isLettresGame) {
                ...
                Row(
                  ...
                  children: [
                    ...buildCases(
                      isLettresGame ? 9 : 6,
                      (index) {
                        if ((isLettresGame && usedLettres.contains(index)) || (!isLettresGame && usedChiffres.contains(index))) {
                          return;
                        }
                        setState(() {
                          if (isLettresGame) {
                ...
                if (!isLettresGame) SizedBox(height: 10),
                if (!isLettresGame)
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
